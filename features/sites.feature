...
Feature: Manage sites
  ...
  Scenario: Users see their roles and statuses at their sites
    ...
    Then user 'bob@example.com' sees the following list on the Sites page
      | Site      | Role | Present |
      | BobPlace1 | Host | Yes     |
    And user 'nancy@example.com' sees the following list on the Sites page
      | Site        | Role    | Present |
      | NancyPlace1 | Host    | Yes     |
      | BobPlace1   | Visitor |         |
