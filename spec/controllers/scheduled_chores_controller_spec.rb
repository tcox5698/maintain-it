...
RSpec.describe ScheduledChoresController, type: :controller do
  ...
  describe 'GET #index' do
    it 'returns a success response' do
      ScheduledChore.create! valid_attributes
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new ScheduledChore' do
        ...
        end.to change(ScheduledChore, :count).by(1)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested scheduled_chore' do
        scheduled_chore = ScheduledChore.create! valid_attributes
        input_params = { id: scheduled_chore.to_param, scheduled_chore: new_attributes }
      ...
      it 'redirects to the scheduled_chore' do
        scheduled_chore = ScheduledChore.create! valid_attributes
        input_params = { id: scheduled_chore.to_param, scheduled_chore: valid_attributes }
        put :update, params: input_params, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'edit' template)" do
        scheduled_chore = ScheduledChore.create! valid_attributes
        input_params = { id: scheduled_chore.to_param, scheduled_chore: invalid_attributes }
        put :update, params: input_params, session: valid_session
        expect(response).to be_successful
        scheduled_chore.reload
